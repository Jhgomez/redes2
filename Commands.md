...
## Static Routing
In order to do static routing we need routers with serial ports for example a router of model 2621XM and add the ports NM-4A/s and interconnect to other routers using this serial ports only using serial DCE cables
